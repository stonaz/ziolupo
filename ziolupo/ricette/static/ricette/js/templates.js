...
<div class='recipe'>\
<img src='<%= media_url+recipe.image %>' width='100' height='75' style='float: left;margin-right: 10px;'>\
...
<div >\
<h1><%= recipe.nome %></h1>\
<img src='<%=media_url+ recipe.image %>' width='200' height='150' style='float: left;margin-right: 10px;'>\
